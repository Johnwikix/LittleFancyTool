...
本工具是一款基于 Windows Forms 开发的桌面应用程序，旨在为用户提供多种常用功能。支持 rs232,rs485 串口通信调试功能，支持常见加密解密的功能如 RSA、SM2、AES、DES、SM4、MD5、SHA、SM3 算法的加密解密，支持图像文本 Base64 转换，支持文件异步多线程加密解密。
